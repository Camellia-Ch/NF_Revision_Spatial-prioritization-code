# Supplementary Information3_Spatial prioritization code of Optimizing individual objective5 (FARMER INCOME of Camellia Price Remains Unchaged)
...
r <- raster("FarmerIncomeGlobalTotalBenefit_CamelliaReplacementinScenario1_CamelliaPriceRemainsUnchaged.tif")
...
for(i in 1:number_iterations){
  ...
  output_filename <- paste0("topPercentage", i, "_scenario1_objective5_CamelliaReplacingPrioritization_CamelliaPriceRemainsUnchaged.tif")
  output_path <- file.path('G:/20251211_Supplementary Information3_Spatial-prioritization-code_Output results/Result_Scenario1_Optimizing individual objective5_prioritization/', output_filename)
...
# Step 2
library(raster)
setwd('G:/20251211_Supplementary Information3_Spatial-prioritization-code_Output results/Result_Scenario1_Optimizing individual objective5_prioritization')
list.files()
files1 = list.files(pattern = ".tif$")
length(files1)
...
writeRaster(r_reversed, 
            "TopPercentage1to100_scenario1_objective5_CamelliaReplacingPrioritization.tif", 
